...
""";
    ...
    public enum EInput
    {
        UP, DOWN, LEFT, RIGHT, ENTER, ESCAPE, T, Y
    }
    public enum GameState
    {
        ADVENTURE, FIGHT, PAUSE, WIN, SHOP
    }
    ...
    {
        PHANTOM, EVE, DDOOK, ZZZ, TOKKI, MAZA, DIGDA, PURIN, PIKA
    }
...
"""
        ...
        public static string[][] All = { Phantom, Eve, DDook, zzz, Tokki, Maza, Digda, Purin, Pika };
